...
public final class GloConst {
	// name of file with authorization data
	public static final String fileNameAuthData = "AuthData.bin";
	
	// directory name where XML files lie
	public static final String filePathToXML = "\\XML\\";
}
